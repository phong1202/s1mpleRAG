...
| 25 | Rewrite placement | **Outside the loop**, run once per request | Decision 11 re-enters at node ②; rewriting the gate's own refined query can drop the term the gate just added |
